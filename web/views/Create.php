...
<form action="<?=site_url('member/proAddDB')?>" enctype="multipart/form-data" id="fm2" method="post">   
        <div class="yctc_458 ycgl_tc_1" id="divMain" style="width: 700px;">
            <ul>
                ...
                <li>
                    ...
                    <select id="selShopList" class="select_215" name="PlatformNoID"  style="width:405px">
                        <option selected="selected" value="0">请选择</option>
                            <?php foreach($shoplist as $vs):?>
                                <option value="<?=$vs->sid?>"><?=$vs->shopname?> | 掌柜号：<?=$vs->seller_nickname?></option>
                            <?php endforeach;?>
                    </select>
                    </p>
                </li>
                <li>
                    ...
                    <p style="line-height: 38px;">
                        <input id="txtShortName" class="input_417" maxlength="50" name="ID" placeholder="请输入该产品在淘宝后台的商品ID" type="text" value="">
                    </p>
                    <p>
                    	&nbsp;&nbsp;<input onclick="getProductInfos()" class="input-butto100-ls" type="button" value="获取商品详情" style="border-radius: 0;">
                    </p>
                </li>
                <li>
                    <p class="sk-zjgl_4">商品链接：</p>
                    <p style="line-height: 38px;">
                        <input style="width: 530px;" class="input_417 is-disabled" id="Url" maxlength="500" name="Url" type="text" value="" readonly="readonly"><br>
                    </p>
                </li>
                <li>
                    <p class="sk-zjgl_4">商品名称：</p>
                    <p style="line-height: 38px;">
                        <input style="width: 530px;" class="input_417 is-disabled" id="FullNameShow" maxlength="200" name="FullName" placeholder="" type="text" value="" readonly="readonly">
                    </p>
                </li>
                <li>
                    <p class="sk-zjgl_4"> 商品主图：</p>
                    <p>
                    <input type="text" id="upfilePCTaoBao" style="display: none" name="product" ></p>
                    <div style="margin-left: 130px;">
                        <a id="aMainProductImg" target="_blank" style="display: block;">
                            <img alt="" id="mainProductImg"  width="150" height="150">
                        </a>
                    </div>
                </li>
                <li style="text-align: center; cursor: default; color: #888">----------------------------------------------------商品自定义信息-------------------------------------------------</li>
                    <li>
                        <p class="sk-zjgl_4">商品简称：</p>
                        <p style="line-height: 38px;">
                            <input id="txtShortName" class="input_417" maxlength="50" name="ShortName" placeholder="输入2-10位中文、数字、英文，简称可以帮助你快速识别商品" type="text" value="">
                        </p>
                    </li>    
                <li>
                    ...
                    <p><input type="file" id="qrCode" style="display: none" name="qrcode[]"></p>
                        <div style="margin-left: 130px;">
                            <a id="qrCodeImg" target="_blank">
                                <img alt="" id="qrCodePic"  width="100" height="70">
                            </a>
                        </div>
                </li>
                <?php else:?>
                ...
                <li>
                    <p class="sk-zjgl_4">商品链接：</p>
                    <p style="line-height: 38px;">
                        <input class="input_417" id="Url" maxlength="500" name="Url" placeholder="商品链接地址（完整的网址）" type="text" value=""><br>
                    </p>
                </li>
                <li>
                    <p class="sk-zjgl_4">商品名称：</p>
                    <p style="line-height: 38px;">
                        <input class="input_417" id="FullNameShow" maxlength="200" name="FullName" placeholder="" type="text" value="">
                    </p>
                </li>
                    <li>
                        <p class="sk-zjgl_4">商品简称：</p>
                    ...
                    <input type="file" id="upfilePCTaoBao" style="display: none" name="product[]" ></p>
                        <div style="margin-left: 130px;">
                            <a id="aMainProductImg" target="_blank">
                                <img alt="" id="mainProductImg"  width="100" height="70">
                            </a>
                        </div>
                </li>
                <li>
            	...
            	<?php endif;?>
        		<li style="text-align: center; cursor: default; color: #888">----------------------------------------------------商品图片信息-------------------------------------------------</li>
        		<li>
                    <p class="sk-zjgl_4"> APP端商品主图：</p>
                    <div id="PCTaoBaoBrowse">
                        <div>
                            <p class="sjzc_6_tu" >
                                <a href="javascript:openBrowse('app_img')" title="无限端商品主图，若电脑端主图和无线端商品主图不一致，则需要上传"></a>
                            </p>
                            <img id="previewImage8" style="margin-left: 10px; display: none; width: 100px; height: 70px;">
                        </div>
                        <img id="previewImage1" style="margin-left: 10px; display: none; width: 100px; height: 70px;">
                    </div>
                    <p><input class="through_train" type="file" id="app_img" style="display: none" name="app_img[]"></p>
                    <div style="margin-left: 130px;">
                        <a id="app_img_Img" target="_blank">
                            <img alt="" id="app_img_Pic"  width="100" height="70">
                        </a>
                    </div>
                </li>
        		<li>
                    ...
                    <div style="margin-left: 130px;">
                        <a id="through_train_1_Img" target="_blank">
                            <img alt="" id="through_train_1_Pic"  width="100" height="70">
                        </a>
                    </div>
                </li>
                <li>
                    ...
                    <div style="margin-left: 130px;">
                        <a id="through_train_2_Img" target="_blank">
                            <img alt="" id="through_train_2_Pic"  width="100" height="70">
                        </a>
                    </div>
                </li>
                <li>
                    ...
                    <div style="margin-left: 130px;">
                        <a id="through_train_3_Img" target="_blank">
                            <img alt="" id="through_train_3_Pic"  width="100" height="70">
                        </a>
                    </div>
                </li>
                <li>
                    ...
                    <div style="margin-left: 130px;">
                        <a id="through_train_4_Img" target="_blank">
                            <img alt="" id="through_train_4_Pic"  width="100" height="70">
                        </a>
                    </div>
                </li>
                <style>
                #aMainProductImg , #qrCodeImg{ display:none;}
                </style>               
           </ul>
...
<div>
        <ul>
            <li class="fpgl-tc-qxjs_4" style=" margin-left:120px">
                <p>
                    <input name="userid" type="hidden"  value="<?=$info->id?>" >
                    <!--<input class="input-butto100-hs" type="submit" value="保存" >-->
                    <input class="input-butto100-hs" type="button" onclick="savePro()" value="保存" >
                </p>
            </li>
        </ul>
