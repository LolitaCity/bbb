...
<body style="background: #fff; padding-left: 2%;">
    <!--列表 -->
    <!--<div class="htyg_tc">
        <ul>
    ...
    <div style="overflow: auto; height: 530px; width: 100%;">
            ...
            <hr/>
            <a id="a1" href="<?=$info->tasktwoimg?>" title="点击查看大图"  target="_blank">
            	<img id="img1" src="<?=$info->tasktwoimg?>" style="padding:0px;margin:0px;vertical-align:middle; width:90%;" />
            </a>
            <br /><br /><br />
             <div style="font-size:18px;">交易订单图：</div>
             <hr/>
             <a id="a1" href="<?=$info->orderimg?>" title="点击查看大图" target="_blank">
            	<img id="img1" src="<?=$info->orderimg?>" style="padding:0px;margin:0px;vertical-align:middle; width:90%;" />
            </a>
            
            <br /><br /><br />
            <?php  if($info -> status > 5 && !empty($evaluateinfo)) { ?>  
             <div style="font-size:18px;">评价图：</div>
             <hr/>
             <a id="a1" href="<?=$evaluateinfo->postimg?>" title="点击查看大图" target="_blank">
            	<img id="img1" src="<?=$evaluateinfo->postimg?>" style="padding:0px;margin:0px;vertical-align:middle; width:90%;" />
            </a>
            <?php
               }
            ?>
