				...
				<div class="yctc_1160 ycgl_tc_1">
					...
					<div class="fprw-kdlx_6">
						<ul>
							...
							<li>
								<p class="fprw-kdlx_7">
									货款：<label style="color: Red"><?=$paytotle?></label> <input
										type="hidden" value="<?=$paytotle?>"> 元
								</p>
							</li>
							<li class="clear"></li>
							<li>
							...
							<li>
								<p class="fprw-kdlx_7">
									合计： <label style="color: Red"><?=$alltotle?></label> 元
								</p>
							</li>
							<li style="color: red;">
								...
								<?php else:?>
									<p>余额预估: <?php $balance = $info -> Money - $gittotle; echo '（余额）' . $info -> Money . ' - (佣金)' . $gittotle . ' = ' . $balance?></p>
								<?php endif;?>
								<br />
