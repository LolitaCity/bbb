...
<div class="index_top">
	<div class="index_top_1">
		<p class="left">
		<a href="/user.html"><img src="<?=base_url()?>style/source/images/login.jpg"></a></p>
	</div>
</div>
    ...
    $(function () {
        $("#subbtn").click(function () {
            ...
            if (msg != '') {
            	...
            	public.ajax('<?=site_url('welcome/registDB')?>', { idkey:$("#idkey").val(), email: $("#email").val(),phonenum: $("#Phonenum").val(),pwd:$("#Pwd").val(), qq: $("#qq").val()}, function(datas){
            		if (datas.status)
            		{
