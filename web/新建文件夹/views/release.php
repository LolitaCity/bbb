...
<div class="fprw-pg" style="margin-top: 0px;">
    <table id="optionContainer">
        <tbody><tr>
            ...
            <th width="358">
                <span style="margin-left: 160px">关键字</span> <span style="margin-left: 50px"><a href="#" target="_blank" style="text-decoration: underline; color: Red;">搜索关键字设置规范</a></span>
            </th>
            <th width="114">数量</th>            
        ...
        <tr id="trHideSearch" style="display: none">
            ...
            <td><input type="text" id="IDSearchKey" name="SearchKey[]" class="input_300" maxlength="500" value="" placeholder="请设置关键字"></td>
            <td><input type="text" id="IDKeyWordCount" name="KeyWordCount[]" class="input_60" maxlength="3" placeholder="0" value="0" onkeyup="value=value.replace(/[^0-9]/g,'')"  onchange="RetaskCountGoods()"></td>            
        ...
        <tr>
            ...
            <td><input type="text" id="IDSearchKey0" name="SearchKey[0]" class="input_300" maxlength="500" value="" placeholder="请设置关键字"></td>
            <td><input type="text" id="IDKeyWordCount0" name="KeyWordCount[0]" class="input_60" maxlength="3" placeholder="0" value="0" onkeyup="value=value.replace(/[^0-9]/g,'')" onchange="RetaskCountGoods()"></td>            
...
function addRow() {	
  ...
  if (seartypeNum > 10) {
      ...
      aDlist = aDlist.replace("SearchKey[]", 'SearchKey['+rowCount+']');
...
function CheckNext(){
	...
	if($("input[name=proid]").val()){
		...
		var n=0;
		$("#optionContainer input[class=input_300]").each(function () {
			//alert($(this).attr('id'));
		    var serchtype = $(this).attr('id').replace(/IDSearchKey/g, "IDSearchType");
			var serchCount = $(this).attr('id').replace(/IDSearchKey/g, "IDKeyWordCount");
			if($("#"+serchtype).val() != 0 ){
