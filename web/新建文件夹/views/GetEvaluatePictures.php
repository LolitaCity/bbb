...
<body style="background: #fff;">
    ...
    <div style="overflow: auto; height: 530px; width: 1000px;">
            ...
            <?php if(isset($evaluateinfo)):?>
            <a id="a1" href="<?=$evaluateinfo->postimg?>" title="点击查看大图" target="_blank"><img id="img1" src="<?=$evaluateinfo->postimg?>" style="padding:0px;margin:0px;vertical-align:middle;"></a>
            <?php endif;?>
    </div>
