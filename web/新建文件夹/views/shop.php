    ...
    <div class="sj-zjgl">
        <div class="zjgl-left">
            ...
            <ul>
                ...
                <li><a href="<?=site_url('member/store')?>" style="background: #eee;color: #ff9900;">店铺管理</a></li><!--  选中栏目 -->
...
<style>
    ...
    .errorbox
    {
        ...
        <div class="sk-hygl">
            <ul>
                <li class="hygl-mh">
                    <p class="hygl-mh_1" style="width: 110px;"> 淘宝店铺：<?=$countshop?> 个</p>
                    <p><input onclick="createShop('<?=site_url('member/addShop')?>',700,550)" class="input-butto100-xls" type="button" value="绑定新店铺"></p>
                </li>
               <!--  
                <li class="hygl-mh">
                ...
                <table>
                    <tbody><tr>
                       ...
                       <!--  <th style="width: 10%">淘宝客推广</th>
                        ...
                        <tr>
                            <td><?=$v->shopname?></td>
                            <td><?=$v->type=='0'?'淘宝':'京东'?><br>（<?=$v->nature=='0'?'个人':'公司'?>）</td>
                            ...
                            <td>
                                <div style="padding-bottom: 5px;">
                                    <input class="button-c" type="button" value="删除" onclick="delShop(<?=$v->sid?>)"></div>
