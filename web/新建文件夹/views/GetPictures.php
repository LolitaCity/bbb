...
<body style="background: #fff;">
    ...
    <div style="overflow: auto; height: 530px; width: 1000px;">
            ...
            <a id="a1" href="<?=$info->tasktwoimg?>" title="点击查看大图" target="_blank"><img id="img1" src="<?=$info->tasktwoimg?>" style="padding:0px;margin:0px;vertical-align:middle;"></a>
            <a id="a1" href="<?=$info->orderimg?>" title="点击查看大图" target="_blank"><img id="img1" src="<?=$info->orderimg?>" style="padding:0px;margin:0px;vertical-align:middle;"></a>
    </div>
