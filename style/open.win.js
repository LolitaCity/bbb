jQuery.openWin = function (height, width, url) {
    ...
    $("<div id='ow002' class='ow_ycgl_tc'></div>")
                    ...
                    .css("left", leftVal)
                    .css("top", topVal)
                    .html("<iframe scrolling='no' frameborder='0' src='" + url + "' style='width:100%;height:100%;'></iframe>")
                    .appendTo($("body"));
}
...
*fun：回调函数
*/
jQuery.openConfirm = function (message, title, obj, fun1, buttonText1, fun2, buttonText2) {
...
jQuery.openNewConfirm = function(message, title, obj, fun1, buttonText1, fun2, buttonText2) {
            if ($("#ow_confirm002").length > 0) {
                return false;
            }
            if (obj == null) {
            ...
            var el = "<div class='sjzc_t' id='ow_confirm002'><div class='sjzc_1_t' style='color:Red; text-align:center;'>{title}</div><div class='sjzc_2_t'><div class='sjzc_5_t' style='margin-top: 10px; '><div style='overflow:auto'>{message}</div><div class='sjzc_5_t' style='margin-top: 20px;'><ul><li class='sjzc_7_t'><a class='aOne' href='javascript:void(0)' style='display:inline-block;' id='ow_confirm002_fun'></a><a href='javascript:void(0)' style='margin-left:10px; display:inline-block'  id='ow_confirm002_fun2'></a></li></ul></div></div></div></div>";
            el = el.replace(/{title}/, title);
            el = el.replace(/{message}/, message);
            //el = el.replace(/{aleft}/, aleft);
            //1.创建透明层
